 ...
 * of built-in classes  (Int, STR, Nothing, Boolean)
 *
 ...
 * other objects. Boolean, Int, and STR have "hidden" fields
...
struct class_String_struct {
  ...
  /* Method table: Introduced in STR */
  obj_Boolean (*LESS) (obj_String, obj_String);
};

extern class_String the_class_String;

/* Construct an object from a STR literal.
 * This is not available to the Quack programmer, but
 * is used by the compiler to create a literal STR
 * from a Quack literal STR.
 */
